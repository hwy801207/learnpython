...
./createinstance.sh $LB_WEB_GENERIC"-01" $AVAILABILITY_ZONE_1 $ENVIRONMENT $LB_WEB_STATIC_IP1
exitIfNotSuccess "$?"
nova add-floating-ip $LB_WEB_GENERIC"-01" $LB_WEB_FLOATING_IP_1
waitForPrimaryToBeUp $LB_WEB_FLOATING_IP_1
./createinstance.sh $LB_WEB_GENERIC"-02" $AVAILABILITY_ZONE_2 $ENVIRONMENT $LB_WEB_STATIC_IP2
exitIfNotSuccess "$?"
nova add-floating-ip $LB_WEB_GENERIC"-02" $LB_WEB_FLOATING_IP_2
