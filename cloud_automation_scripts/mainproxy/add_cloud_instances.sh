...
./createinstance.sh "$MAIN_PROXY_GENERIC-01" $AVAILABILITY_ZONE_1 $ENVIRONMENT $MAIN_PROXY_STATIC_IP1
exitIfNotSuccess "$?"
nova add-floating-ip "$MAIN_PROXY_GENERIC-01" $MAIN_PROXY_FLOATING_IP_1
waitForPrimaryToBeUp $MAIN_PROXY_FLOATING_IP_1
./createinstance.sh "$MAIN_PROXY_GENERIC-02" $AVAILABILITY_ZONE_2 $ENVIRONMENT $MAIN_PROXY_STATIC_IP2
exitIfNotSuccess "$?"
nova add-floating-ip "$MAIN_PROXY_GENERIC-02" $MAIN_PROXY_FLOATING_IP_2
waitForPrimaryToBeUp $MAIN_PROXY_FLOATING_IP_2
